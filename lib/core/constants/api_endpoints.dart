...
class ApiEndpoints {
  ...
  //OTP
  static String OTPEndpoint = "$baseUrl/otp";
  static String sendOTP = "$OTPEndpoint/sms";
  ...
  static String rentalLocationImagesApiEndpoint = baseUrl + _rentalLocationImagesEndpoint;
  static String findRentalLocationImagesByRentalLocationIdApiEndpoint = "$rentalLocationImagesApiEndpoint/rental-location";
  ...
  static String findSubscriptionByAccountIdApiEndpoint = "$subscriptionApiEndpoint/account";
  ...
  static String findUserSubscriptionByAccountIdApiEndpoint = "$userSubscriptionApiEndpoint/account";
}