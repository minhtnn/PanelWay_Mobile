...
// // Your existing CustomMarkerWidget
// class CustomMarkerWidget extends StatefulWidget {
//   final String label;
//   final Color color;
//   final bool isSelected;
...
//     MapStyle.dark: MapStyleData(
//       name: 'Dark',
//       urlTemplate: "https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}.png?api_key=${AppConstrant.flutterMapApiKey}",
//       icon: Icon(Icons.nights_stay, color: Colors.grey[800]),
//     ),
//     MapStyle.light: MapStyleData(
//       name: 'Light',
//       urlTemplate: 'https://tiles.stadiamaps.com/tiles/alidade_smooth/{z}/{x}/{y}.png?api_key=${AppConstrant.flutterMapApiKey}',
//       icon: Icon(Icons.light_mode, color: Colors.orange),
//     ),
//     MapStyle.satellite: MapStyleData(
//       name: 'Satellite',
//       urlTemplate: 'https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}?api_key=${AppConstrant.flutterMapApiKey}',
//       icon: Icon(Icons.satellite, color: Colors.green),
//     ),
//   };
...
//     LocationInfo(
//       name: 'Independence Palace',
//       description: 'Historic landmark that served as South Vietnam\'s presidential palace.',
//       location: LatLng(10.762622, 106.660172),
//       markerColor: Colors.blue,
//     ),
//     LocationInfo(
//       name: 'Notre-Dame Cathedral',
//       description: 'Iconic French colonial era cathedral in the heart of Ho Chi Minh City.',
//       location: LatLng(10.77689, 106.700806),
//       markerColor: Colors.green,
//     ),
//   ];

//   List<Marker> get markers => locations.map((loc) => 
//     NonRotatingMarker(
//       point: loc.location,
//       width: 120,
//       height: 80,
...
//                     child: Column(
//                       crossAxisAlignment: CrossAxisAlignment.start,
//                       children: mapStyles.entries.map((style) => 
//                         MaterialButton(
